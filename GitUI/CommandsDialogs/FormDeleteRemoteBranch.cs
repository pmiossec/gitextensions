...
namespace GitUI.CommandsDialogs
{
    public sealed partial class FormDeleteRemoteBranch : GitExtensionsDialog
    {
        ...
        protected override void OnRuntimeLoad(EventArgs e)
        {
            ...
            Branches.SetLoader(() => Module.GetRefs(RefsFilter.Remotes).ToList(), refName => Module.GetRef("refs/remotes/" + refName));
        ...
        private void Delete_Click(object sender, EventArgs e)
        {
            ...
            foreach ((string remote, IEnumerable<IGitRef> branches) in selectedBranches.GroupBy(b => b.Remote))
            {
                ...
                if (!form.ErrorOccurred() && !Module.InTheMiddleOfAction())
                {
                    ...
                    {
                        List<string> localTrackingBranches = Module.GetRefs(RefsFilter.Heads).Where(b => selectedBranches.Any(r => b.IsTrackingRemote(r)))
