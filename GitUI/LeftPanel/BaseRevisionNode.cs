...
namespace GitUI.LeftPanel
{
    ...
    internal abstract class BaseRevisionNode : Node
    {
        ...
        private static readonly Color invisibleForeColor = Color.Silver.AdaptTextColor();
        ...
        public override void ApplyStyle()
        {
            ...
            TreeViewNode.ForeColor = Visible && TreeViewNode.TreeView is not null ? TreeViewNode.TreeView.ForeColor : invisibleForeColor;
