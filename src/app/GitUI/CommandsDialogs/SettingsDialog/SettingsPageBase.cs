...
namespace GitUI.CommandsDialogs.SettingsDialog
{
    ...
    public abstract partial class SettingsPageBase : TranslatedControl, ISettingsPage
    {
        ...
        public static T Create<[MeansImplicitUse] T>(ISettingsPageHost pageHost, IServiceProvider serviceProvider, bool isRepoValid) where T : SettingsPageBase
        {
            T result = (T)Activator.CreateInstance(typeof(T), serviceProvider, isRepoValid);
